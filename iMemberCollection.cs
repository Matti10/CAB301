...
namespace Assignment
{
    ...
    interface iMemberCollection
    {
        ...
        iMember[] toSortedArray(); //outputs the members in this collection to a sorted array of iMember

        iMember SearchMember(string firstname, string lastname); // search for member using first and lastname

        bool SearchMemberName(string firstname, string lastname); //search system for member, using thier firstname and surname
    }
}
