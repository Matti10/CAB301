...
namespace Assignment
{
    interface iToolLibrarySystem
    {
        ...
        public iMember searchMember(string firstname, string lastname); //search for a member

        public iMember searchMember(); //search for a member
        ...
        public iTool searchTool(string name); // returns a tool from a tool name
